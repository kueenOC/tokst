...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/tokst
```

A live public deployment of this template is available at [https://tokst.templates.workers.dev](https://tokst.templates.workers.dev)
